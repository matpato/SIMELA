...
/*
// $Id: //open/mondrian/testsrc/main/mondrian/xmla/test/XmlaTest.java#21 $
 ...
 *
 * @author Gang Chen
 * @version $Id: //open/mondrian/testsrc/main/mondrian/xmla/test/XmlaTest.java#21 $
 */
public class XmlaTest extends TestCase {
    ...
    private static Element executeRequest(Element requestElem) {
        ...
        XmlaHandler handler =
            new XmlaHandler((ConnectionFactory) context.dataSources(),"xmla");
        XmlaRequest request = new DefaultXmlaRequest(requestElem, null,null,null,null);
        XmlaResponse response = new DefaultXmlaResponse(resBuf, "UTF-8", null);
