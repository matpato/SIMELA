...
/*
// $Id: //open/mondrian/testsrc/main/mondrian/test/TestContext.java#82 $
 ...
 * @version $Id: //open/mondrian/testsrc/main/mondrian/test/TestContext.java#82 $
 */
public class TestContext {
    ...
    public String compileExpression(String expression, final boolean scalar) {
        ...
        final CalcWriter calcWriter = new CalcWriter(pw, scalar);
        ...
        return new DelegatingTestContext(this)
        {
            ...
            public Connection getConnection() {
                if (connection == null) {
                    ...
                    try {
						((OlapConnection) connection).setScenario(
						    ((OlapConnection) connection).createScenario());
