...
public class EEG_Fragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(fragmentRootContainer == null) {
            ...
            if (chart == null)
                chart = new Chart((LineChart) fragmentRootContainer.findViewById(R.id.chart), EEG, 41.5f, -41.5f);
                ...
                if (!stop) {
                    if (!run) {
                        if (MainFragment.bluetoothDevice != null) {
                            ...
                            intentService.putExtra(ManageConnectedSocket.EXAM_TYPE, EEG);
                            intentService.putExtra(ManageConnectedSocket.ANALOG_CHANNELS,  new int[]{3});
                            ...
                            if(getView() != null) {
                                if (getView().getTag().equals("tablet_screen"))
    ...
    public void onResume() {
        ...
        IntentFilter intentFilter = new IntentFilter(ManageConnectedSocket.ACTION_IntentService_EEG);
    ...
    private class BroadcastReceiverData extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getBooleanExtra(ManageConnectedSocket.EXAM_COMPLETED, false)){
                ...
                chart.addEntry(intent.getIntExtra(ManageConnectedSocket.X_KEY_OUT, 0), intent.getDoubleArrayExtra(ManageConnectedSocket.DATA_KEY_OUT)[3]);
