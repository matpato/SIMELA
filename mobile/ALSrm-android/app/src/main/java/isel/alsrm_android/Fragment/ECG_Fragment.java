...
public class ECG_Fragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(fragmentRootContainer == null) {
            ...
            if (chart == null)
                chart = new Chart((LineChart) fragmentRootContainer.findViewById(R.id.chart), ECG, 1.5f, -1.5f);
                ...
                if (!stop) {
                    if (!run) {
                        if (MainFragment.bluetoothDevice != null) {
                            ...
                            intentService.putExtra(ManageConnectedSocket.EXAM_TYPE, ECG);
                            intentService.putExtra(ManageConnectedSocket.ANALOG_CHANNELS,  new int[]{1});
    ...
    public void onResume() {
        ...
        IntentFilter intentFilter = new IntentFilter(ManageConnectedSocket.ACTION_IntentService_ECG);
    ...
    private class BroadcastReceiverData extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(intent.getBooleanExtra(ManageConnectedSocket.EXAM_COMPLETED, false)){
                ...
                chart.addEntry(intent.getIntExtra(ManageConnectedSocket.X_KEY_OUT, 0), intent.getDoubleArrayExtra(ManageConnectedSocket.DATA_KEY_OUT)[1]);
