...
public class ECG_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // no description text
        mChart.setDescription("ECG - " + getIntent().getExtras().getString("area"));
        ...
        button_start_stop.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View arg0) {
                if (!start) {

                    ManageConnectedSocket manageConnectedSocket = new ManageConnectedSocket(MainActivity.bluetoothDevice, MainActivity.samplingFrequency, new int[] {1}, new int[] {1, 0, 1, 1});
