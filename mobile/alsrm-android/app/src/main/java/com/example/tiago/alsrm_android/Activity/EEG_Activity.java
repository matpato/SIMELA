...
public class EEG_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // no description text
        mChart.setDescription("EEG - " + getIntent().getExtras().getString("area"));
        ...
        leftAxis.setAxisMinValue(-41.5f);
        ...
        button_start_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (!start) {
                    ...
                    ManageConnectedSocket manageConnectedSocket = new ManageConnectedSocket(MainActivity.bluetoothDevice, MainActivity.samplingFrequency, new int[] {3}, new int[] {1, 0, 1, 1});
