...
public class ACC_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // no description text
        mChart.setDescription("ACC - " + getIntent().getExtras().getString("area"));
        ...
        button_start_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (!start) {
                    ...
                    ManageConnectedSocket manageConnectedSocket = new ManageConnectedSocket(MainActivity.bluetoothDevice, MainActivity.samplingFrequency, new int[] {4}, new int[] {1, 0, 1, 1});
