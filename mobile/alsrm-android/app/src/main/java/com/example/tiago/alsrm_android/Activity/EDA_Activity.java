...
public class EDA_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // no description text
        mChart.setDescription("EDA - " + getIntent().getExtras().getString("area"));
        ...
        button_start_stop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if (!start) {
                    ...
                    ManageConnectedSocket manageConnectedSocket = new ManageConnectedSocket(MainActivity.bluetoothDevice, MainActivity.samplingFrequency, new int[] {2}, new int[] {1, 0, 1, 1});
